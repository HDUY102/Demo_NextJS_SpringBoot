...
const DashboardChildrent = ({children}:{children: React.ReactNode}) => {
  return (
    <div className='grid grid-cols-1 grid-rows-5 md:grid-cols-[auto_1fr_100px]
     md:grid-rows-[100px_1fr_150px] text-black bg-white'>
        ...
        <div className='row-start-3 bg-blue-600 md:row-start-2 md:col-start-2'>{children}</div>
